...
function NavBar({asideNav,setStreakToggleMode,streakRef}) {
  ...
  return (
    <nav className='flex justify-between items-center fixed md:relative w-[90%] left-1/2 -translate-x-1/2 top-3 z-[40] bg-slate-200/80 p-3 rounded-full border-t-2 border-white border-b-2  backdrop-blur-md'>
      <FontAwesomeIcon icon={faBars} className='md:hidden' onClick={toggleAsideNav} />
